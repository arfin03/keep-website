    ...
    try {
        ...
        if (data.ok && data.items && data.items.length > 0) {
            data.items.forEach((item, index) => {
                ...
                const scoreValue = item.score || item.count;
                ...
                <div class="glass-card" style="display:flex; align-items:center; gap:12px; padding:12px;">
                    ...
                    <!-- Avatar -->
                    <img src="${item.avatar}" style="width:40px; height:40px; border-radius:50%; object-fit:cover; border:2px solid rgba(255,255,255,0.2);">
                    ...
                    <div style="flex:1;">
                        ...
                        <div style="font-size:12px; opacity:0.7; margin-top:2px; display:flex; justify-content:space-between; align-items:center;">
                            ...
                            <span style="color:#ffd700; font-weight:bold; font-size:14px;">${scoreValue}</span>
                        </div>
                    </div>
                </div>
                `;
